...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute est compromis dans une fuite de données. Veuillez choisir un autre mot de passe.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Lignes de langue personnalisées pour les attributs
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes permettent de personnaliser les messages de validation
    | pour des attributs spécifiques en fonction des besoins de l'application.
    |
    */
