...
@section('content')
<main>
    <title>EcoImpact - Sign In page</title>
    <!-- Section -->
    <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
        <div class="container">
            ...
            style="background-image: url('/assets/img/illustrations/signin.svg');">
                        ...
                        <form action="#" class="mt-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex justify-content-between align-items-top mb-4">
                                    ...
                                    <div><a href="/forgotPassword" class="small text-right">Lost password?</a>
                                    </div>
                                </div>
                            </div>
                            <div class="d-grid">
